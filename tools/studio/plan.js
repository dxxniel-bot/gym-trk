...
(function(){ 'use strict';
  ...
  window.TRK_PLAN = {
    updated: '2026-09-22',
    note: 'ruta de la guía: G1 y G2 hechos, F0 y T preparan el estudio; G0 se decide aquí, G3 aplica la identidad y G4 la completa. Cada entrega G3 borra el CSS de su propuesta y la marca shipped.',
    phases: [
      ...
      P('G0', 'decisiones', null, 'por decidir', [
        I('nav', 'nav: cápsula 999 o --r-float; activa inversa o entre [ ]', 'por decidir', { proposal: 'nav' }),
        I('primary', 'primario gym//TRK: sólido inverso o vidrio + borde', 'por decidir', { proposal: 'primary' }),
        I('float', 'radio flotante --r-float: 8 o 12', 'por decidir', { proposal: 'float' }),
        I('ring', 'panel del anillo: plano, caja de 2 px o vidrio sutil', 'por decidir', { proposal: 'ring' }),
        I('icons', 'set de íconos TRK (share, camera, nav, escáner)', 'por decidir', { proposal: 'icons' }),
        I('boot', 'shader del arranque corregido o una variante', 'por decidir', { proposal: 'boot' }),
        I('field', 'borde de campo editable con contraste WCAG 1.4.11', 'por decidir', { proposal: 'field' }),
      ...
      P('G3a', 'chrome', 'v262', 'pendiente', [
        I('nav', 'nav elegida (texto, ≥44, sin animar columnas, oculta en secundarias)', 'por decidir', { proposal: 'nav', audit: 'RADF 9→0' }),
        I('float', '--r-float elegido en nav, sheet, toast, popover y barras', 'por decidir', { proposal: 'float', audit: 'RADF 9→0' }),
        ...
        I('motion', 'la nav no anima layout', 'pendiente', { audit: 'MOTION ↓' }),
      ]),

      P('G3b', 'formas del contenido', 'v263', 'pendiente', [
        I('cards', '.card/.grp/.ptile/.hcal → panel //TÍTULO + regla o caja de 2 px', 'pendiente', { proposal: 'cards', audit: 'RAD 46→0' }),
        I('corners', 'esquinas de contenido a 0–2 (decidido)', 'pendiente', { proposal: 'corners', audit: 'RAD-2 · B-05' }),
        I('primary', 'primario gym//TRK en .start/.ok/.save, uno por vista', 'por decidir', { proposal: 'primary', audit: 'OK ≤1 por plantilla' }),
        I('secondary', 'secundarios como [verbo] (decidido)', 'pendiente', { proposal: 'secondary', audit: 'M3-08' }),
        I('field', 'borde de campo solo en editables', 'por decidir', { proposal: 'field' }),
        I('ring', 'panel del anillo sin tarjeta ni brillo', 'por decidir', { proposal: 'ring', audit: 'M4-03' }),
      ...
      P('G3c', 'voz, glifos y color', 'v264', 'pendiente', [
        I('labels', '//etiquetas de sistema en inglés (decidido)', 'pendiente', { proposal: 'english', audit: 'LANG 11→0 · T-05' }),
        ...
        I('green', 'verde solo en el glifo o el número; fresco sin verde', 'pendiente', { proposal: 'green', audit: 'T-08 · SEM ↓' }),
        I('recovery', 'recovery ~43 en una línea, sin héroe ni color de veredicto (decidido)', 'pendiente', { proposal: 'recovery', audit: 'T-07 · M5-01' }),
        I('retention', 'retención como fila de diagnóstico solo fuera de rango', 'pendiente', { proposal: 'retention', audit: 'M4-01' }),
        I('wordmark', 'marca única gym//TRK', 'pendiente', { proposal: 'wordmark', audit: 'M3-13' }),
      ]),

      P('G3d', 'íconos y arranque', 'v265', 'pendiente', [
        I('icons', 'icon(name) reemplaza NAVIC y EXSH_SVG', 'por decidir', { proposal: 'icons', audit: 'M2-12' }),
        I('scan', 'ícono TRK del escáner', 'por decidir', { proposal: 'icons' }),
        I('shader', 'shader elegido con /max y celdas cuadradas (sin comprimir)', 'por decidir', { proposal: 'boot', audit: 'T-11' }),
      ...
      P('G4a', 'interacción', 'v266', 'pendiente', [
      ...
      P('G4b', 'movimiento y limpieza', 'v267', 'pendiente', [
        I('spinner', 'spinner de texto', 'pendiente'),
      ...
      P('G4c', 'honestidad y estados', 'v268', 'pendiente', [
