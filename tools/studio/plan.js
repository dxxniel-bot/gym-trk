  ...
  window.TRK_PLAN = {
    ...
    phases: [
      ...
      P('G0', 'decisiones', null, 'por decidir', [
        ...
        I('float', 'radio flotante --r-float: 12 (look "1", 22-sep)', 'hecho', { proposal: 'float' }),
      ...
      P('G3a', 'chrome', 'v262', 'pendiente', [
        ...
        I('float', '--r-float 12 en nav, sheet, toast, popover y barras · v262', 'hecho', { proposal: 'float', audit: 'RADF 9→0' }),
