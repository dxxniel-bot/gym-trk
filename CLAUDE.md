...
## Pending / next
- **✅ DONE (v25) — canonical per-100 food model (math correctness).** Implemented + verified in preview (porción=130, envase=1040, ×2=2080; legacy migration reproduces printed values; OFF/AI producers map to per100). Below = the shipped design for reference.
